  ...
  <div>
    <el-card class="box-card" shadow="always" style="border-radius: 20px;">
      <div slot="header" class="clearfix">
        <p align="left" style="font-size: 20px">用户注册</p>
      </div>
      <div style="min-height: 600px;">
        <el-row>
          <el-col :span="20" :offset="4">
            <el-form ref="form" style="width: 500px;" :model="users" :rules="rules" label-width="100px"
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="save" size="mini">注册</el-button>
        </div>
      </div>
    </el-card>
