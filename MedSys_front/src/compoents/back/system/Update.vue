    ...
    <div>
      <el-card class="box-card" shadow="always" style="border-radius: 20px;">
        ...
        <div style="min-height: 600px">
          <el-row>
            <el-col :offset="5">
              <el-card class="box-card" shadow="hover" style="border-radius: 20px; width: 600px;background-image: linear-gradient(#BAF5DE, #FFFFFF);">
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$confirm('您确定要修改密码吗？', '提示', {
              ...
              this.$axios.post('back/updatePass',formData)
                .then(resp => {
                  if (resp.data.code === 1) {
                    this.$message({
